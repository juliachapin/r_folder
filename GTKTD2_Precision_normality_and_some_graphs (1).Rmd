...
These data in Aguadilla_Fruit_Phenology_for_R.csv are of the total fruit produced by plants at SY’s research site in Aguadilla, Puerto Rico. Import it here, call it **afp**, and use the head() function to show the first six lines of the dataframe.
